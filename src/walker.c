            ...
            // We are "paused" inside the loop.
            {
                ...
                */
                ...
                if (seg->type == RBCG_SEGMENT_WILDCARD)
                {
                    ...
                    // Reuse previous logic (truncated for brevity, let's copy-paste or assume helper?)
                    // I need to include the match logic here.
                    // To avoid huge code duplication, I should have extracted `match_wildcard_strategy` but I cannot create new file easily.
                    // I will inline the switch case, it's safer.
