...
bool rbc_glob(const char **patterns,
              size_t npatterns,
              unsigned flags,
              const char *base,
              bool sort,
              ...
              size_t *count,
              size_t **lengths);
bool rbc_xglob(const rbc_glob_pattern_t *gp,
               const char *base,
               bool sort,
               char ***out,
               size_t *count,
...
bool rbc_xfnmatch(const rbc_fnmatch_pattern_t *fp, const char *path);
